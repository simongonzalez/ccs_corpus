...
#In dhlabR: National Library of Norway Quantitative Text Data 
...
setwd('/Users/pradeepchandran/ccs_corpus/Summer2024/01_Microservices/1_TranscriptionMapping')

print(getwd())

#duration files
#fls_df <- read.csv('XX_duration_files_20240324.csv')

#...............................................................................
#Read in manual transcription
df_doc <- data.frame(raw = str_squish(unlist(strsplit(read_doc('Input_Output/Input/CA1HA_87.doc'), '\n')))) %>%
...
dfson = read_srt('Input_Output/Input/CA1HA_87.mp3.srt', collapse = "\n") %>%
...
#Saves the TextGrid
save_name <- paste0('./Input_Output/Output/', 'CA1HA_87.TextGrid')
