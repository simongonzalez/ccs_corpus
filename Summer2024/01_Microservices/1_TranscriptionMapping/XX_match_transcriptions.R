...
dfson = read_srt('/Users/calejohnstone/Documents/wk/ESP/2024/CCS/CCSFiles/data/OneDrive_1_20-03-2024/Transcripts_Sonix_5sec/CA1HA_87.mp3.srt', collapse = "\n") %>%
...
#Saves the TextGrid
save_name <- paste0('./CCSFiles/XX_TG_Matched/', 'CA1HA_87.TextGrid')
