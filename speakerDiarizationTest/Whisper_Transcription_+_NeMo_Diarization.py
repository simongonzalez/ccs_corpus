...
get_ipython().system('pip install nemo_toolkit[asr]==1.17.0')
get_ipython().system('pip install faster-whisper==0.5.1')
get_ipython().system('pip install git+https://github.com/m-bain/whisperX.git@4cb167a225c0ebaea127fd6049abfaa3af9f8bb4')
get_ipython().system('pip install git+https://github.com/facebookresearch/demucs#egg=demucs')
get_ipython().system('pip install transformers>=4.26.1')
get_ipython().system('pip install deepmultilingualpunctuation')
